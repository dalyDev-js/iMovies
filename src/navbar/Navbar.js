        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900 fixed w-full z-10  ">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="flex md:order-2">
              ...
              <Button click={handleDarkMode} darkMode={isDarkMode} />
              <button
                className="flex justify-center items-center gap-3 text-gray-500 dark:text-gray-400  ml-5  rounded-lg text-sm p-2.5"
                onClick={() => changeLanguage()}>
                {language === "en" ? (
                  <img src="/uk.png" alt="uk" />
                ) : (
                  <img src="/egypt.webp" alt="egypt" />
                )}
            ...
            <div
              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <NavLink
                    onClick={() => {
                      handleChangeType("movie");
                    }}
                    to="/"
                    className={({ isActive }) =>
                      isActive
                        ? "text-blue-700"
                        : "text-gray-900 dark:text-white hover:text-blue-700 dark:hover:text-blue-700"
                    }>
                    Movies
                  </NavLink>
                </li>
